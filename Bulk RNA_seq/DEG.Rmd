...
DGE <- function(dds,condition,file){
  ...
  filename <- str_c("/data/msun/projects/02_DEG/DESeq2/",name,"/",unique(dds@colData$Tissue),condition[1],"vs",condition[2])
...
DGE <- function(dds,condition){
  ...
  gene_diff[which(gene_diff$padj >= 0.05),'sig'] <- 'none'
  dgtable <- gene_diff %>% as.data.frame() %>% merge(dge.norm$genes,by=0,all.x = TRUE) %>% .[,-1]
  filename <- str_c("/data/msun/projects/02_DEG/DESeq2/deg_table_sedvsrw/",unique(dds@colData$Tissue),"/",unique(dds@colData$Tissue),condition[1],"vs",condition[2])
  print(unique(dds@colData$Tissue))
  write.csv(dgtable, file = paste(filename,".csv",sep = ""))
}
...
DGE <- function(dds){
  ...
  gene_diff[which(gene_diff$padj >= 0.05),'sig'] <- 'none'
  dgtable <- gene_diff %>% as.data.frame() %>% merge(dge.norm$genes,by=0,all.x = TRUE) %>% .[,-1]
  filename <- str_c("/data/msun/projects/02_DEG/DESeq2/deg_table_logfcfc/",unique(dds@colData$Tissue),"logFCFC_RWSedF_RWSedM")
  print(unique(dds@colData$Tissue))
  write.csv(dgtable, file = paste(filename,".csv",sep = ""))
}
...
DGE <- function(dds){
  ...
  gene_diff[which(gene_diff$padj >= 0.05),'sig'] <- 'none'
  dgtable <- gene_diff %>% as.data.frame() %>% merge(dge.norm$genes,by=0,all.x = TRUE) %>% .[,-1]
  filename <- str_c("/data/msun/projects/02_DEG/DESeq2/deg_table_logfcfc/",unique(dds@colData$Tissue),"logFCFC_RWSedF16_RWSedM16")
  print(unique(dds@colData$Tissue))
  write.csv(dgtable, file = paste(filename,".csv",sep = ""))
}
...
DGE <- function(dds){
  ...
  gene_diff[which(gene_diff$padj >= 0.05),'sig'] <- 'none'
  dgtable <- gene_diff %>% as.data.frame() %>% merge(dge.norm$genes,by=0,all.x = TRUE) %>% .[,-1]
  filename <- str_c("/data/msun/projects/02_DEG/DESeq2/deg_table_logfcfc/",unique(dds@colData$Tissue),"logFCFC_RWSedF4_RWSedM4")
  print(unique(dds@colData$Tissue))
  write.csv(dgtable, file = paste(filename,".csv",sep = ""))
}
...
DGE <- function(dds,condition){
  ...
  gene_diff[which(gene_diff$padj >= 0.05),'sig'] <- 'none'
  dgtable <- gene_diff %>% as.data.frame() %>% merge(dge.norm$genes,by=0,all.x = TRUE) %>% .[,-1]
  filename <- str_c("/data/msun/projects/02_DEG/DESeq2/deg_table_zt4vs16/",unique(dds@colData$Tissue),"/",unique(dds@colData$Tissue),condition[1],"vs",condition[2])
  print(unique(dds@colData$Tissue))
  write.csv(dgtable, file = paste(filename,".csv",sep = ""))
}
...
DGE <- function(dds){
  ...
  gene_diff[which(gene_diff$padj >= 0.05),'sig'] <- 'none'
  dgtable <- gene_diff %>% as.data.frame() %>% merge(dge.norm$genes,by=0,all.x = TRUE) %>% .[,-1]
  filename <- str_c("/data/msun/projects/02_DEG/DESeq2/deg_table_logfcfc/",unique(dds@colData$Tissue),"logFCFC_FMRW_FMSed")
  print(unique(dds@colData$Tissue))
  write.csv(dgtable, file = paste(filename,".csv",sep = ""))
}
...
combinealldata <- function(tissue){
  ...
  deseq.sedrw <- list.files(path = paste("/data/msun/projects/02_DEG/DESeq2/deg_table_sedvsrw",tissue,sep = "/"), full.names = TRUE) %>% 
    map(funs) %>% purrr::reduce(inner_join, by = "gene_id")
  
  deseq.zt <- list.files(path = paste("/data/msun/projects/02_DEG/DESeq2/deg_table_zt4vs16",tissue,sep = "/"), full.names = TRUE) %>% 
    map(funs) %>% purrr::reduce(inner_join, by = "gene_id")
  
  deseq.gender <- list.files(path = paste("/data/msun/projects/02_DEG/DESeq2/deg_table_mvsf",tissue,sep = "/"), full.names = TRUE) %>% 
    map(funs) %>% purrr::reduce(inner_join, by = "gene_id")
  ...
  print(tissue)
  write.xlsx(combined.table,file = str_c("/data/msun/projects/02_DEG/combined_deseq/",tissue,".xlsx"))
}
...
my_function <- function(tissue){
  df <- read.xlsx(str_c("/data/msun/projects/02_DEG/combined_deseq/",tissue,".xlsx"))
...
write.csv(all.df,file="/data/msun/projects/02_DEG/countDEG.csv")
...
for (com in compare.list) {
  alldf <- map(names(dge.list), function(x){
    df <- read.xlsx(str_c("/data/msun/projects/02_DEG/combined_deseq/",x,".xlsx"))
...
write.csv(biotype.deg,file="/data/msun/projects/02_DEG/deginrw.countbybiotype.csv")
...
write.csv(DEG_uni_biotye,file="/data/msun/projects/02_DEG/deginrw.ubi.countbybiotype.csv")
