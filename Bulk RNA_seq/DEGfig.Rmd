...
pheatmap(numdf,
        ...
        border_color = "grey60")
write.csv(numdf,file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/heat.sedrw.csv")
#10*10 inch
```
...
write.csv(numdf,file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/heat.fsedrw.csv")
#10*10 inch
```
#FIG 3A male 
```{r}
...
write.csv(numdf,file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/heat.msedrw.csv")
#10*10 inch
```
...
write.csv(numdf,file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/heat.zt16sedrw.csv")
#10*10 inch
```
#FIG 4A ZT4
```{r}
...
pheatmap(numdf,
        ...
        color = colorRampPalette(colors = c("white","red","black"))(200),
        border_color = "grey60")
write.csv(numdf,file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/heat.zt4sedrw.csv")
#10*10 inch
```
...
write.csv(df, file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/bar.sedrw.csv")
#Fig2B
...
write.csv(data2,file = "/data/msun/projects/pandas/geraldine/02_DEG/upmore5tissue.csv")
...
write.csv(data4,file = "/data/msun/projects/pandas/geraldine/02_DEG/downmore5tissue.csv")

data <- df[,colnames(df) %in% c("BF","ST","SM","TA","EDL","Gas","Sol","Quad")]
write.csv(data,file = "/data/msun/projects/pandas/geraldine/02_DEG/muscles_sedrw.csv")
```
...
ratio <- max(sigcount$sig_num) / 0.6#max(sigcount$per)
df <- transform(sigcount, uniScaled = per * ratio)
write.csv(df, file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/bar.fsedrw.csv")
#Fig2B
ggplot(df,aes(x=factor(tissue,levels = c("Hypothal", "Pituitary","Adrenal" ,"BrownAdip","inguinWAT","epididWAT","Kid","Liver" ,"Lung","Heart","Dia","BF","SM" ,"ST","Quad","Gas","Sol" ,"TA" ,"EDL" ,"GasTen","EDLTen","TATen")), y=sig_num,fill=tissue))+
  scale_fill_manual(values = cols)+
  geom_bar(stat = 'identity') + 
...
ratio <- max(sigcount$sig_num) / 0.6#max(sigcount$per)
df <- transform(sigcount, uniScaled = per * ratio)
write.csv(df, file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/bar.msedrw.csv")
#Fig2B
ggplot(df,aes(x=factor(tissue,levels = c("Hypothal", "Pituitary","Adrenal" ,"BrownAdip","inguinWAT","epididWAT","Kid","Liver" ,"Lung","Heart","Dia","BF","SM" ,"ST","Quad","Gas","Sol" ,"TA" ,"EDL" ,"GasTen","EDLTen","TATen")), y=sig_num,fill=tissue))+
  scale_fill_manual(values = cols)+
  geom_bar(stat = 'identity') + 
...
ratio <- max(sigcount$sig_num) / 0.6#max(sigcount$per)
df <- transform(sigcount, uniScaled = per * ratio)
write.csv(df, file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/bar.zt4sedrw.csv")
#Fig2B
ggplot(df,aes(x=factor(tissue,levels = c("Hypothal", "Pituitary","Adrenal" ,"BrownAdip","inguinWAT","epididWAT","Kid","Liver" ,"Lung","Heart","Dia","BF","SM" ,"ST","Quad","Gas","Sol" ,"TA" ,"EDL" ,"GasTen","EDLTen","TATen")), y=sig_num,fill=tissue))+
  scale_fill_manual(values = cols)+
  geom_bar(stat = 'identity') + 
...
df <- transform(sigcount, uniScaled = per * ratio)
write.csv(df, file = "/data/msun/projects/pandas/geraldine/02_DEG/fig/bar.zt16sedrw.csv")
#Fig2B
ggplot(df,aes(x=factor(tissue,levels = c("Hypothal", "Pituitary","Adrenal" ,"BrownAdip","inguinWAT","epididWAT","Kid","Liver" ,"Lung","Heart","Dia","BF","SM" ,"ST","Quad","Gas","Sol" ,"TA" ,"EDL" ,"GasTen","EDLTen","TATen")), y=sig_num,fill=tissue))+
  scale_fill_manual(values = cols)+
  geom_bar(stat = 'identity') + 
